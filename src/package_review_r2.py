"""R2 payload/equivalence/manifest/ZIP DAG for explicitly prepared local trees.
...
PUBLIC_ZIP = 'Stage1B_R2_Public_Review_Bundle.zip'
MIN_ZIP = 'Stage1B_R2_Review_Bundle_MIN.zip'
GENERATED = {
...
ROOT_PUBLIC_FILES = {
    ...
    '00_REVIEW_INDEX.md', '01_CHECKPOINT_1B_R2_REPORT.md', '02_FINAL_STATUS.json',
    '03_TARGETED_FIXES_AND_ORDER_GUARD.md', '04_DUNE_POLICY_MIGRATION_AND_USAGE.md',
    '05_PILOT_COLLECTION_AND_COVERAGE.md', '06_BALANCE_GAS_AND_WETH.md',
    '07_AMOUNT_RESULTS_AND_BASELINE_DIFF.md', '08_LABEL_AND_REFERENCE_DELTA.md',
    '09_TEST_RESULTS.json', '10_GITHUB_PUBLICATION_REPORT.md', '11_RESUME_AND_OPEN_ISSUES.md',
    'CONTINUATION_GATE.json',
}
PUBLIC_CONFIGS = {
    'DUNE_ADAPTER_SCHEMA.md', 'PROVIDER_REPAIR_NOTES.md', 'VALIDATION_R1.md',
    'VALIDATION_R2.md', 'requirements_lp.txt', 'STAGE1B_POLICY.json',
    'STAGE1B_R1_PUBLIC_POLICY.json', 'STAGE1B_R2_PUBLIC_POLICY.json',
    'PUBLIC_VALIDATION_R2.json',
}
...
def _equivalence(min_tree, public_tree, differences):
    ...
    return {'schema': 'stage1b-r2-payload-equivalence-dag-v1',
