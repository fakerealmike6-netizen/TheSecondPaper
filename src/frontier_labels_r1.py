...
def build_sql(addresses, schema):
    ...
    """
    addresses = sorted({full_address(x) for x in addresses})
    if not addresses or len(addresses) > 40:
        raise ValueError('Expected 1..40 frozen actual-frontier addresses')
