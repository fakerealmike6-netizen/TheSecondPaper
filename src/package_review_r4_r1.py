"""R4 payload/equivalence/manifest/ZIP DAG for explicitly prepared local trees.
...
PUBLIC_ZIP = 'Stage1B_R4_R1_Public_Review_Bundle.zip'
MIN_ZIP = 'Stage1B_R4_R1_Review_Bundle_MIN.zip'
GENERATED = {
...
ROOT_PUBLIC_FILES |= {
    '01_CHECKPOINT_1B_R4_REPORT.md',
    '03_REPAIR_CLOSURE_MATRIX.md', '03_REPAIR_CLOSURE_MATRIX.json',
    '04_RETRY_POLICY_AND_FAULT_TESTS.md', '05_SAME_INPUT_REPLAY_AND_AMOUNT_DIFF.md',
    '06_HISTORICAL_LABEL_AND_CACHE_IMPACT.md', '07_WETH_REMAINING_GAPS_OR_CERTIFICATION.md',
    '08_BUDGET_AND_REQUEST_LEDGER.md', 'REPAIR_GATE_R4_PUBLIC.json',
}
...
PUBLIC_CONFIGS |= {'STAGE1B_R3_PUBLIC_POLICY.json', 'PUBLIC_VALIDATION_R3.json', 'VALIDATION_R3.md',
                   'STAGE1B_R4_PUBLIC_POLICY.json', 'PUBLIC_VALIDATION_R4.json', 'VALIDATION_R4.md'}
PUBLIC_MANIFESTS = {'PUBLIC_SOURCE_MAPPING.json', 'PUBLIC_PAYLOAD_APPROVAL.json'}
ROOT_PUBLIC_FILES |= {'01_CHECKPOINT_1B_R4_R1_REPORT.md', '03_RECEIPT_REGRESSION_CLOSURE.md',
                     '04_SAME_INPUT_AND_WETH_MATERIALS.md', '05_TEST_RESULTS.json',
                     '06_GITHUB_PUBLICATION_REPORT.md', 'REPAIR_CLOSURE.json'}
PUBLIC_CONFIGS |= {'STAGE1B_R4_R1_PUBLIC_POLICY.json', 'PUBLIC_VALIDATION_R4_R1.json',
                   'VALIDATION_R4_R1.md', 'STAGE1B_R4_PUBLIC_POLICY.json'}
...
def _equivalence(min_tree, public_tree, differences):
    ...
    return {'schema': 'stage1b-r4-r1-payload-equivalence-dag-v1',
