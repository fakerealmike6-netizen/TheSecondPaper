...
with offline_operation(C,'current_actual_semantic_source_gate_rebind'):
 ...
 receipt={'status':'ACTUAL_CERTIFICATES_REVALIDATED_NEW_SOURCE_GATE','utc':now(),
  ...
  'unit_ids':sorted(current.units),'same_physical_certificate_bytes':True,'new_external_requests':0,'solver_runs':0,'new_online_sessions':0}
