...
PUBLIC_ZIP = 'Stage1B_R4_Public_Review_Bundle.zip'
MIN_ZIP = 'Stage1B_R4_Review_Bundle_MIN.zip'
GENERATED = {
...
def _equivalence(min_tree, public_tree, differences):
    ...
    return {'schema': 'stage1b-r4-payload-equivalence-dag-v1',
